"""Pure input builders for Aegis scan runs."""
...
from aegis.config.models import DEFAULT_MODEL_RETRY, model_supports_reasoning


if TYPE_CHECKING:
    from aegis.config.settings import ReasoningEffort
