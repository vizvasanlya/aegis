"""Execution loop for addressable SDK-backed Aegis agents."""
...
from aegis.core.inputs import child_initial_input
from aegis.core.sessions import open_agent_session, strip_all_images_from_session
...
if TYPE_CHECKING:
    ...
    from aegis.core.agents import AgentCoordinator, Status
...
async def _append_noninteractive_tool_required_message(
    *,
    ...
    message = (
        "Your previous response ended the autonomous Aegis run without a lifecycle tool call. "
