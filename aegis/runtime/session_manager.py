...
from aegis.runtime.backends import get_backend
from aegis.runtime.caido_bootstrap import bootstrap_caido
...
async def create_or_reuse(
    ...
    *,
    ...
    bundle = {
        ...
        "caido_url": host_caido_url,  # Store for reconnection
    }
